...
public class JvmOptimizeImportsTestGenerated extends AbstractJvmOptimizeImportsTest {
    ...
    public static class Jvm extends AbstractJvmOptimizeImportsTest {
        ...
        public void testAlreadyOptimized() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/AlreadyOptimized.kt");
        }

        @TestMetadata("CallableReference.kt")
        public void testCallableReference() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/CallableReference.kt");
        }

        @TestMetadata("CallableReference2.kt")
        public void testCallableReference2() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/CallableReference2.kt");
        }

        @TestMetadata("ClassFromSameFileImportAddedBug.kt")
        public void testClassFromSameFileImportAddedBug() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/ClassFromSameFileImportAddedBug.kt");
        }

        @TestMetadata("DoNotTouchIfNoChanges.kt")
        public void testDoNotTouchIfNoChanges() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/DoNotTouchIfNoChanges.kt");
        }

        @TestMetadata("DuplicatedImports.kt")
        public void testDuplicatedImports() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/DuplicatedImports.kt");
        }

        @TestMetadata("FromCompanionObject.kt")
        public void testFromCompanionObject() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/FromCompanionObject.kt");
        }

        @TestMetadata("FromCompanionObjectGeneric.kt")
        public void testFromCompanionObjectGeneric() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/FromCompanionObjectGeneric.kt");
        }

        @TestMetadata("JavaStaticField.kt")
        public void testJavaStaticField() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/JavaStaticField.kt");
        }

        @TestMetadata("KDocReference.kt")
        public void testKDocReference() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/KDocReference.kt");
        }

        @TestMetadata("KT10226.kt")
        public void testKT10226() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/KT10226.kt");
        }

        @TestMetadata("Kt1850FullQualified.kt")
        public void testKt1850FullQualified() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/Kt1850FullQualified.kt");
        }

        @TestMetadata("Kt1850InnerClass.kt")
        public void testKt1850InnerClass() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/Kt1850InnerClass.kt");
        }

        @TestMetadata("NestedClassInObject.kt")
        public void testNestedClassInObject() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/NestedClassInObject.kt");
        }

        @TestMetadata("Operators.kt")
        public void testOperators() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/Operators.kt");
        }

        @TestMetadata("PlusAndPlusAssign.kt")
        public void testPlusAndPlusAssign() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/PlusAndPlusAssign.kt");
        }

        @TestMetadata("RemoveImportsIfGeneral.kt")
        public void testRemoveImportsIfGeneral() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/RemoveImportsIfGeneral.kt");
        }

        @TestMetadata("RemoveImportsIfGeneralBefore.kt")
        public void testRemoveImportsIfGeneralBefore() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/RemoveImportsIfGeneralBefore.kt");
        }

        @TestMetadata("SamConstructor.kt")
        public void testSamConstructor() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/SamConstructor.kt");
        }

        @TestMetadata("StaticMethodFromSuper.kt")
        public void testStaticMethodFromSuper() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/StaticMethodFromSuper.kt");
        }

        @TestMetadata("ThisAndSuper.kt")
        public void testThisAndSuper() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/ThisAndSuper.kt");
        }

        @TestMetadata("TrivialAlias.kt")
        public void testTrivialAlias() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/TrivialAlias.kt");
        }

        @TestMetadata("UnusedImports.kt")
        public void testUnusedImports() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/UnusedImports.kt");
        }

        @TestMetadata("WithAliases.kt")
        public void testWithAliases() throws Exception {
            KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/WithAliases.kt");
        }
        ...
        public static class AllUnderImports extends AbstractJvmOptimizeImportsTest {
            ...
            public void testClassNameConflict() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflict.kt");
            }

            @TestMetadata("ClassNameConflict2.kt")
            public void testClassNameConflict2() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflict2.kt");
            }

            @TestMetadata("ClassNameConflictWithCurrentPackage.kt")
            public void testClassNameConflictWithCurrentPackage() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflictWithCurrentPackage.kt");
            }
            ...
            public void testClassNameConflictWithCurrentPackage2() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflictWithCurrentPackage2.kt");
            }

            @TestMetadata("ClassNameConflictWithDefault.kt")
            public void testClassNameConflictWithDefault() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflictWithDefault.kt");
            }
            ...
            public void testClassNameConflictWithinDefaultImports() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/ClassNameConflictWithinDefaultImports.kt");
            }

            @TestMetadata("NameCountSetting.kt")
            public void testNameCountSetting() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/NameCountSetting.kt");
            }

            @TestMetadata("PackagesToUseStarImport.kt")
            public void testPackagesToUseStarImport() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/PackagesToUseStarImport.kt");
            }

            @TestMetadata("Simple.kt")
            public void testSimple() throws Exception {
                KotlinTestUtils.runTest(this::doTest,TargetBackend.ANY, "idea/testData/editor/optimizeImports/jvm/allUnderImports/Simple.kt");
            }
        }
    }
