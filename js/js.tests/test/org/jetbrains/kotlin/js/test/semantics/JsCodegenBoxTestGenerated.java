...
public class JsCodegenBoxTestGenerated extends AbstractJsCodegenBoxTest {
    ...
    public static class Bridges extends AbstractJsCodegenBoxTest {
        ...
        public void testJsName() throws Exception {
            KotlinTestUtils.runTest("compiler/testData/codegen/box/bridges/jsName.kt", this::doTest);
        }

        @TestMetadata("jsNative.kt")
        public void testJsNative() throws Exception {
            KotlinTestUtils.runTest("compiler/testData/codegen/box/bridges/jsNative.kt", this::doTest);
        }
    ...
    public static class PrimitiveTypes extends AbstractJsCodegenBoxTest {
        ...
        public void testCrossTypeEquals() throws Exception {
            KotlinTestUtils.runTest("compiler/testData/codegen/box/primitiveTypes/crossTypeEquals.kt", this::doTest);
        }
